...
export default function JoinPage() {
  return (
    <main className="bg-paper">
        ...
        <Container className="relative py-20 md:py-28">
          <Reveal className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-wrap gap-x-6 gap-y-2 text-sm font-medium text-ink-mute">
              ...
              <span className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-lime" /> Launching August 2026
              </span>
            </div>
          </Reveal>
        </Container>
            ...
            <ul className="grid gap-4 sm:grid-cols-2">
              {whoCanJoin.map((item, i) => (
                <Reveal
                  ...
                  key={item}
                  delay={i * 60}
                  className="flex items-start gap-3.5 rounded-2xl bg-paper p-5"
                >
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {youReceive.map((item, i) => (
              <Reveal
                key={item.title}
                delay={(i % 4) * 80}
                className="flex flex-col rounded-3xl bg-snow p-7 shadow-[0_18px_50px_-30px_rgba(14,18,24,0.3)]"
              >
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_1fr] lg:gap-16">
            ...
            <Reveal delay={100}>
              ...
              <p className="mt-6 text-lg leading-relaxed text-carbon-ink/80">
                You only need to arrive willing to participate, ask questions and
                work towards your next move.
              </p>
            </Reveal>
          </div>
        </Container>
      ...
      {/* Refer someone mini-CTA */}
      <section className="bg-snow">
        <Container className="pb-24 md:pb-32">
          <Reveal className="overflow-hidden rounded-3xl border border-line bg-paper p-8 md:p-12">
