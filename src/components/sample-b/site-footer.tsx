  ...
  return (
    <footer className="relative overflow-hidden bg-midnight text-soft-grey">
      ...
      <Container className="relative">
        <div className="flex flex-col items-center gap-4 border-t border-white/10 py-6 text-[11px] uppercase tracking-[0.16em] text-soft-grey/50 md:flex-row md:justify-between">
