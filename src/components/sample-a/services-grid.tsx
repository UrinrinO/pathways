      ...
      <div className="hidden items-stretch gap-6 md:flex">
        {pillars.map((p, i) => {
          ...
          return (
            ...
            >
              <article className="flex min-h-[360px] flex-1 flex-col rounded-3xl bg-snow p-8 shadow-[0_18px_50px_-30px_rgba(14,18,24,0.35)] md:p-9">
                <span className="text-sm font-semibold tracking-[0.15em] text-lime">
                  {p.n}
                </span>
                <h3 className="mt-5 whitespace-nowrap text-2xl font-bold tracking-tight text-ink">
                  {p.title}
                </h3>
                ...
                <div className="relative mt-7 flex-1">
                  <p
                    className="absolute inset-0 max-w-sm leading-relaxed text-ink-soft transition-all duration-500"
                    style={{
                      opacity: on ? 1 : 0,
                  ...
                  <div
                    className="absolute inset-0 flex items-start text-ink-mute transition-opacity duration-500"
                ...
                <a
                  href="/programme"
                  className="group mt-8 inline-flex w-fit items-center gap-1.5 border-b border-ink/30 pb-1 text-sm font-medium text-ink"
                >
                  View more
      ...
      <div className="grid gap-4 md:hidden">
        {pillars.map((p) => (
          ...
          >
            ...
            <a
              href="/programme"
              className="group mt-6 inline-flex w-fit items-center gap-1.5 border-b border-ink/30 pb-1 text-sm font-medium text-ink"
            >
