...
import { ServicesGrid } from "@/components/sample-a/services-grid";
...
/** Scroll-highlight statement + badge + CTA, then the width-accordion cards. */
        ...
        <div className="flex justify-end">
          <div className="max-w-2xl text-right">
            ...
            <div className="mt-9 flex justify-end">
              <a
                href="/join"
                className="group inline-flex items-center gap-2.5 rounded-full bg-ink px-7 py-4 text-[15px] font-semibold text-lime transition-colors hover:bg-carbon"
              >
                Start your Pathway
                <span
                  aria-hidden
