...
export function HeroShowcase() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[560px] sm:h-[540px]">
      ...
      <div className="absolute right-0 top-0 hidden h-72 w-60 rotate-[6deg] overflow-hidden rounded-3xl shadow-xl ring-1 ring-black/5 sm:block">
      ...
      {/* Notes card */}
      <div className="relative z-10 w-full rounded-2xl bg-snow shadow-2xl ring-1 ring-black/5 sm:absolute sm:left-10 sm:top-8 sm:w-[420px] sm:max-w-[88%]">
        {/* window bar */}
      ...
      <div className="relative z-20 mx-auto mt-5 w-40 overflow-hidden rounded-2xl bg-ink shadow-2xl ring-1 ring-black/10 sm:absolute sm:bottom-2 sm:right-0 sm:mt-0">
        <video
